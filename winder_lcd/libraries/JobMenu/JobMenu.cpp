...
void startJob(Floatbyte_t wireSize, Floatbyte_t turnsTotal,
  ...
  uint8_t parameterData[I2C_TX_LENGTH] = {};
  ...
  *pparameterData++ = stackUp.numberWholeLayers;
  ...
  Wire.write(parameterData, I2C_TX_LENGTH);
...
void updateDisplay(double total_turns) {
  ...
  do {
    ...
    Wire.requestFrom(8, I2C_RX_LENGTH);

    uint8_t statusArray[I2C_RX_LENGTH];
